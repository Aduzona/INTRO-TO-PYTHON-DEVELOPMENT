...
#print(" variable type "+ str(type(birthday)))# its a string

print("Date of birth "+ birthday) # displays the value from user.


#When you convert the string containing the date into object
# you must specify the expected date format
# if the date is not in the expected format Python will raise an exception
birthday_date = datetime.strptime(birthday,'%d/%m/%Y') #convert the string to date object
